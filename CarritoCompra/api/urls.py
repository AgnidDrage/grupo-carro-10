...
from .views import UserView, ProductoCompradoView, VentaView, carrosCompraView
...
urlpatterns = [
    ...
    path('carrosCompra/', carrosCompraView.as_view(), name='carrosCompra-list'),
    path('carrosCompra/<int:id>', carrosCompraView.as_view(), name='carrosCompra-process'),
